...
class EvalPowerOp:
    "Class to evaluate exponent expressions"
...
def eval(string):
    return comp_expr.parseString(string)[0].eval()
...
if __name__ == "__main__":
    ...
    #     else:
    #         print("")
    print('2**2**3', eval('2**2**3'))
    print('2**(2**3)', eval('2**(2**3)'))
    print('8**8**9', eval('8**8**9'))
    # print('3^2/1v0*3', eval('3^2/1v0*3'))
    print('2-2', eval('2-2'))
